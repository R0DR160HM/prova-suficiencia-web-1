...
export class EmployeesListView extends View {
    template(model) {
        ...
        <section class="card p-5">
            ...
            ${(model === null || model === void 0 ? void 0 : model.totalElements) ? `
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <th class="d-none d-sm-table-cell align-middle">${(employee === null || employee === void 0 ? void 0 : employee.id) || -1}</th>
                        <th class="d-none d-sm-table-cell align-middle text-center">
                            <img class="img-thumbnail" width="50" height="50" src="${employee === null || employee === void 0 ? void 0 : employee.profileImage}">
                        </th>
                        <th class="align-middle">${employee === null || employee === void 0 ? void 0 : employee.name}</th>
                        <th class="align-middle">${employee === null || employee === void 0 ? void 0 : employee.age}<span class="d-none d-sm-inline"> anos</span></th>
                        <th class="align-middle"><span class="d-none d-sm-inline">R$ </span>${employee === null || employee === void 0 ? void 0 : employee.formattedSalary}</th>
                    </tr>
                    `).join(' ')}
                </tbody>
            </table>
